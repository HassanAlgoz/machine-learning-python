...
description: >
  ...
  (2) Understanding Quarto's code cell syntax with hashpipe (#|) options, (3) Setting up cross-references
...
Task: Create presentations and speaker notes
Use: [references/presentations.md](references/presentations.md)
...
Details: [references/presentations.md](references/presentations.md)
...
- [references/presentations.md](references/presentations.md) - Speaker notes, fragments, backgrounds, columns
