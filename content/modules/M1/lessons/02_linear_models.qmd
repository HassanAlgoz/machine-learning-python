...
1. Recognize the code for modeling the relationship between two variables
2. Map target data type (Numerical or Categorical) to suitable model type (`LinearRegression` or `LogisticRegression`)
3. Given a target variable for prediction, identify which model  to use
4. Given a 2D-plot, identify the dependent variable and the independent variable
5. Distinguish between a regression line and a decision boundary
6. Recognize when linear models wouldn't fit the data well (linear seprability)
...
See: [MLPlayGrounds.com for an interactive Linear Regression Demonstration](https://mlplaygrounds.com/machine/learning/linearRegression.html).
